...
export const products: Product[] = [
  {
    ...
    tag: "NOVO",
    category: "Moletons",
    description: "Moletom exclusivo Outsee Gang. Design autêntico para quem vive o estilo underground. Conforto premium com estilo streetwear. Disponível em 5 cores.",
    colors: [
      { name: "Preto", hex: "#111111", image: product1 },
